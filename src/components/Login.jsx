  ...
  render() {
    return (
			<div className="Login">
				...
				<Link to="/account" id="login-button" class="waves-effect waves-light btn">Login</Link>
				<Link to="/signup/1" id="login-button" class="waves-effect waves-light btn">Sign Up</Link>
			</div>
    );
  }
}
